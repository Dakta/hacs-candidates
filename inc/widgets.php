...
class Twenty_Fourteen_Ephemera_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'widget_twentyfourteen_ephemera', 'Twenty Fourteen Ephemera', array(
			'classname'   => 'widget_twentyfourteen_ephemera',
			'description' => 'Use this widget to list your recent Aside, Quote, Video, Audio, Image, Gallery, and Link posts',
		) );
